...
"color: rgb(255, 255, 255);")
        ...
        self.sale.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
...
"border-bottom: 1px solid #00394D;")
        ...
        self.itemsale = QtWidgets.QComboBox(self.centralwidget)
        self.itemsale.setMinimumSize(QtCore.QSize(0, 47))
        self.itemsale.setMaximumSize(QtCore.QSize(1000, 47))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(False)
        font.setItalic(True)
        font.setWeight(50)
        self.itemsale.setFont(font)
        self.itemsale.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.itemsale.setAcceptDrops(True)
        self.itemsale.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.itemsale.setAutoFillBackground(True)
        self.itemsale.setStyleSheet("")
